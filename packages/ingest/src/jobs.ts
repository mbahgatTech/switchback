...
export async function drainJobs(
  ...
  options: {
     ...
     * which is right only where something else does the bounding — the Function App's scale
     * limit, or a test. Every path that runs on Vercel passes one; see `drainSlotGate`.
     */
    gate?: ClaimGate;
  } = {},
): Promise<DrainResult> {
