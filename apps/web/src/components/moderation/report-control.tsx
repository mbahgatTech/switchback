    ...
    return (
      <div>
        <p className="max-w-measure text-body leading-relaxed">
          We have it. A moderator reads every report and answers within{' '}
          {MODERATION_CONTACT.responseDays} days. If it needs taking down sooner, it will be.
        </p>
  ...
  return (
    ...
    >
      ...
      {file.isError ? (
         ...
         */
        <p className="mt-lg max-w-measure rounded-hair border border-survey px-md py-sm text-caption text-survey">
          That report did not send. Try again, or write to {MODERATION_CONTACT.email} and say which
          page it was on.
        </p>
      ) : null}
